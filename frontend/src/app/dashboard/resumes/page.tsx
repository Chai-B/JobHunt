...
import { UploadCloud, Edit2, FileText, Activity, Trash2, AlertTriangle } from "lucide-react";
                                        ...
                                        <TableRow key={r.id} className="border-border hover:bg-secondary/50 transition-colors">
                                            ...
                                            <TableCell className="text-right">
                                                <div className="flex items-center justify-end gap-2">
                                                    ...
                                                    <Button variant="outline" size="sm" className="bg-transparent border-destructive/30 text-destructive hover:bg-destructive/10" onClick={() => setDeleteConfirmId(r.id)} disabled={deleting === r.id}>
