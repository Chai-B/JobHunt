...
import {
  ...
  Shield, Clock, Cpu, Globe, Lock, Layers
} from "lucide-react";
...
const workflow = [
  ...
  { step: "02", title: "Create & Send", desc: "Build AI-powered email templates with dynamic tags like {name}, {company}, {role}. Tags auto-fill from your resume and contacts — no manual editing.", icon: Mail, color: "from-violet-500/20 to-violet-600/5" },
...
const capabilities = [
  ...
  { text: "Encrypted credentials at rest", icon: Lock },
];
    ...
    <div className="min-h-screen bg-black text-white overflow-x-hidden selection:bg-white/20">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 sm:px-10 lg:px-16">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10 pt-16">
          ...
          {/* Subtext */}
          <FadeIn delay={200}>
            <p className="text-xl sm:text-2xl text-zinc-400 max-w-2xl mx-auto leading-relaxed mb-10 font-light">
              The self-hosted platform that tracks applications, sends cold emails,
              and monitors your inbox — while you focus on interviews.
            </p>
          </FadeIn>

          {/* Trust indicators */}
          <FadeIn delay={250}>
            <div className="flex items-center justify-center gap-6 mb-12 text-sm text-zinc-600">
          ...
          <div className="w-full max-w-7xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
            {[
              ...
              <FadeIn key={s.label} delay={i * 100} className="text-center sm:text-left">
                <div className="text-4xl sm:text-5xl font-medium text-white tracking-tight mb-1"><AnimatedCounter value={s.value} /></div>
      ...
      <section className="px-6 sm:px-10 lg:px-16 pb-8">
        <FadeIn>
          <div className="w-full max-w-7xl mx-auto p-6 sm:p-8 rounded-2xl border border-emerald-500/10 bg-emerald-500/[0.03] flex flex-col sm:flex-row items-start sm:items-center gap-5">
            ...
            <div className="flex-1 min-w-0">
              <h3 className="text-base font-medium text-white mb-1">Security-first architecture</h3>
              <p className="text-sm text-zinc-500 leading-relaxed">
                All API keys and credentials are Fernet-encrypted at rest. OAuth tokens never leave your server.
                Self-hosted deployment means your data stays under your control — always.
              </p>
            </div>
          </div>
        </FadeIn>
